                    ...
                    <table className="min-w-full leading-normal">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap">44567</p>
                                </td>
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap">
                                        Jan 01, 2020
                            ...
                            <tr>
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap">67998</p>
                                </td>
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap">
                                        Jan 10, 2020
                            ...
                            <tr>
                                ...
                                <td className="px-5 py-5 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap">900456</p>
                                </td>
                                <td className="px-5 py-5 bg-white text-sm">
