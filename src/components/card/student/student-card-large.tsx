    ...
    <div className="container my-40 ">
            <div className="bg-white relative shadow rounded-lg w-full mx-auto">
                <div className="flex justify-center">
                    <img src="https://www.gravatar.com/avatar/2acfb745ecf9d4dccb3364752d17f65f?s=260&d=mp" alt="" className="rounded-full mx-auto absolute -top-20 w-32 h-32 shadow-md border-4 border-white transition duration-200 transform hover:scale-110" />
                </div>
